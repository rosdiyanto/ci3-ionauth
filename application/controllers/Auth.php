...
class Auth extends CI_Controller
{
	 ...
	 */
	 ...
	 {
		$data['status login'] = $this->ion_auth->logged_in();
		$data['status admin'] = $this->ion_auth->is_admin();
		// $data['status user'] = $this->ion_auth->get_users_groups()->result();
		$data['users_groups'] = $this->ion_auth->get_users_groups()->result();
		$data['user sekarang'] = $this->ion_auth->get_users_groups()->row('name');
